        ...
        <div className="p-3 md:p-5 space-y-3 md:space-y-5 relative z-10">
          ...
          <div className="text-center space-y-0.5">
            ...
            <h1 className="text-lg md:text-xl font-serif leading-tight">
              ...
              <span className="text-gradient-gold italic">bởi chuyên gia HuyNailsBoss</span>
            </h1>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4 items-center bg-white/5 rounded-[24px] p-3 md:p-4 border border-white/10 relative overflow-hidden shadow-2xl">
            ...
            <div className="space-y-1 text-center md:text-left relative z-10">
              <div className="flex items-center justify-center md:justify-start gap-2">
                <span className="text-white/30 text-base line-through font-serif">Giá gốc: $999</span>
                <span className="px-1.5 py-0.5 bg-red-500 text-[8px] font-bold rounded uppercase tracking-tighter">Giảm 50%</span>
              </div>
              <div className="text-3xl md:text-4xl font-serif text-gradient-gold font-black tracking-tighter">Ưu đãi: $499</div>
            ...
            <div className="flex flex-col items-center gap-1 border-t md:border-t-0 md:border-l border-white/10 pt-3 md:pt-0 md:pl-4 relative z-10">
              <div className="flex items-center gap-2 text-gold-400 font-bold text-[9px] uppercase tracking-[0.4em] mb-0.5 drop-shadow-[0_0_8px_rgba(212,175,55,0.5)]">
                <Clock size={12} className="animate-spin-slow" /> Bảng giờ ưu đãi
              </div>
              <div className="flex gap-4">
                <div className="flex flex-col items-center">
                  ...
                  <span className="text-[10px] text-gold-400 font-black uppercase mt-1 tracking-[0.3em]">Phút</span>
                </div>
                <div className="text-3xl font-serif text-gold-500 self-center mb-4 animate-pulse font-bold">:</div>
                <div className="flex flex-col items-center">
                  <div className="w-16 h-16 bg-rich-black/90 border-2 border-gold-500 rounded-2xl flex items-center justify-center text-3xl font-mono shadow-[0_0_40px_rgba(212,175,55,0.3)] relative group overflow-hidden">
                    <div className="absolute inset-0 bg-gradient-to-br from-gold-500/20 to-transparent opacity-50" />
                    <AnimatePresence mode="wait">
                  ...
                  <span className="text-[10px] text-gold-400 font-black uppercase mt-1 tracking-[0.3em]">Giây</span>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="space-y-2">
            <div className="text-center space-y-0.5">
              <h2 className="text-base font-serif text-gold-300 uppercase tracking-[0.3em]">Thông Tin Thanh Toán</h2>
            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div className="p-8 rounded-[32px] bg-white/5 border border-white/10 space-y-6 hover:border-gold-500/30 transition-all group relative overflow-hidden">
                ...
                <div className="flex items-center gap-3 text-gold-400 relative z-10">
                  <CreditCard size={24} />
                  <span className="text-sm font-bold uppercase tracking-[0.2em]">HSBC Vietnam</span>
                </div>
                <div className="space-y-4 relative z-10">
                  <div className="space-y-1">
                    <p className="text-[10px] text-white/40 uppercase tracking-widest">1.1 Số tài khoản / Account No.</p>
                    <p className="text-2xl font-mono text-gradient-gold tracking-tighter font-bold">090-772526-001</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-[10px] text-white/40 uppercase tracking-widest">1.2 Loại tiền tệ / Currency</p>
              ...
              <div className="p-8 rounded-[32px] bg-white/5 border border-white/10 space-y-6 hover:border-gold-500/30 transition-all group relative overflow-hidden">
                ...
                <div className="flex items-center gap-3 text-gold-400 relative z-10">
                  <Wallet size={24} />
                  <span className="text-sm font-bold uppercase tracking-[0.2em]">PayPal</span>
                </div>
                <div className="flex items-center gap-8 relative z-10">
                  <div className="space-y-2 flex-1">
                    <p className="text-[10px] text-white/40 uppercase tracking-widest">Paypal Email:</p>
                    <p className="text-base font-mono text-gold-200 break-all font-bold">Hngo7@hotmail.com</p>
                  </div>
                </div>
              </div>
              ...
              <div className="p-8 rounded-[32px] bg-white/5 border border-white/10 space-y-6 hover:border-gold-500/30 transition-all group relative overflow-hidden">
                ...
                <div className="flex items-center gap-3 text-gold-400 relative z-10">
                  <QrCode size={24} />
                  <span className="text-sm font-bold uppercase tracking-[0.2em]">Zelle</span>
                </div>
                <div className="flex items-center gap-6 relative z-10">
                  <div className="space-y-2 flex-1">
                    <p className="text-lg font-bold text-white/90 uppercase tracking-tight">ERIC NGO</p>
                    <p className="text-sm font-mono text-gold-200 font-bold">(***) ***-6788</p>
                    <p className="text-[10px] text-white/40 uppercase mt-2 tracking-tighter">Quét mã để thanh toán</p>
                  </div>
              ...
              <div className="p-8 rounded-[32px] bg-white/5 border border-white/10 space-y-6 hover:border-gold-500/30 transition-all group relative overflow-hidden">
                ...
                <div className="flex items-center gap-3 text-gold-400 relative z-10">
                  <QrCode size={24} />
                  <span className="text-sm font-bold uppercase tracking-[0.2em]">Venmo</span>
                </div>
                <div className="flex items-center gap-6 relative z-10">
                  <div className="space-y-2 flex-1">
                    <p className="text-lg font-bold text-white/90 uppercase tracking-tight">ERIC NGO</p>
                    <p className="text-sm font-mono text-gold-200 font-bold">@Hngo7</p>
                    <p className="text-[10px] text-white/40 uppercase mt-2 tracking-tighter">Quét mã để thanh toán</p>
                  </div>
                  <div className="shrink-0 group-hover:scale-105 transition-transform duration-300">
                    <img 
          ...
          <div className="pt-4 border-t border-white/5 text-center space-y-4">
            <div className="flex items-center justify-center gap-6 text-white/40 text-[9px] uppercase tracking-[0.2em]">
              <div className="flex items-center gap-1"><ShieldCheck size={10} className="text-gold-500" /> Bảo mật 100%</div>
              <div className="flex items-center gap-1"><Star size={10} className="text-gold-500" /> Chuyên gia 10 năm</div>
            </div>
            
            <div className="space-y-1">
              <p className="text-white/20 text-[9px] uppercase tracking-widest">
                Vui lòng chụp màn hình giao dịch và gửi cho chúng tôi sau khi hoàn tất.
              </p>
              <div className="flex items-center justify-center gap-2 pt-2">
                <div className="w-6 h-6 bg-gradient-gold rounded-full flex items-center justify-center">
                  <span className="text-rich-black font-bold text-[10px]">H</span>
                </div>
                <span className="font-serif text-base tracking-wider text-gradient-gold font-bold italic">HuyNailsBoss Academy</span>
              </div>
            </div>
          </div>
        </div>
